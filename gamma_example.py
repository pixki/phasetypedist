...
# @Last Modified time: 2015-11-18 11:34:50
...
x = np.linspace(gamma.ppf(0.00001, a, scale=lambdap), gamma.ppf(
    0.99999, a, scale=lambdap), num=1000)
ax.plot(x, gamma.pdf(x, a, scale=lambdap), 'r-',
        lw=5, alpha=0.6, label='gamma pdf')

# Alternatively, the distribution object can be called (as a function) to fix
# the shape, location and scale parameters. This returns a “frozen” RV object
